...
const Second = () => (
  <svg width="65" height="64" viewBox="0 0 65 64" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <g clipPath="url(#clip0_4501_54316)">
      <path d="M40.724 26.6668H42.0573C43.4718 26.6668 44.8283 27.2287 45.8285 28.2289C46.8287 29.2291 47.3906 30.5857 47.3906 32.0002C47.3906 33.4146 46.8287 34.7712 45.8285 35.7714C44.8283 36.7716 43.4718 37.3335 42.0573 37.3335H40.724M40.724 26.6668H19.3906V38.6668C19.3906 40.0813 19.9525 41.4379 20.9527 42.4381C21.9529 43.4383 23.3095 44.0002 24.724 44.0002H35.3906C36.8051 44.0002 38.1617 43.4383 39.1619 42.4381C40.1621 41.4379 40.724 40.0813 40.724 38.6668V26.6668ZM35.3906 17.3335V21.3335M30.0573 17.3335V21.3335M24.724 17.3335V21.3335" stroke="url(#paint0_linear_4501_54316)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </g>
    <defs>
...
const Third = () => (
  <svg width="65" height="64" viewBox="0 0 65 64" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect x="0.724609" width="64" height="64" rx="32" fill="#0F0F10" />
    <path d="M32.724 45.3332C40.0878 45.3332 46.0573 39.3636 46.0573 31.9998C46.0573 24.636 40.0878 18.6665 32.724 18.6665C25.3602 18.6665 19.3906 24.636 19.3906 31.9998C19.3906 39.3636 25.3602 45.3332 32.724 45.3332Z" stroke="url(#paint0_linear_4501_54324)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M38.3773 26.3465L35.5506 34.8265L27.0706 37.6532L29.8973 29.1732L38.3773 26.3465Z" stroke="url(#paint1_linear_4501_54324)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    <defs>
...
const Fifth = () => (
  <svg width="65" height="64" viewBox="0 0 65 64" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect x="0.724609" width="64" height="64" rx="32" fill="#0F0F10" />
    <path d="M32.724 23.9998V31.9998L38.0573 34.6665M46.0573 31.9998C46.0573 39.3636 40.0878 45.3332 32.724 45.3332C25.3602 45.3332 19.3906 39.3636 19.3906 31.9998C19.3906 24.636 25.3602 18.6665 32.724 18.6665C40.0878 18.6665 46.0573 24.636 46.0573 31.9998Z" stroke="url(#paint0_linear_4501_54340)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    <defs>
